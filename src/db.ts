/**
 * SQLite database access layer for the Slovenian Financial Regulation MCP server.
 *
 * Schema covers ATVP (Agencija za trg vrednostnih papirjev) and
 * BS (Banka Slovenije) regulatory output:
 *   - sourcebooks        — top-level sourcebook directories (ATVP_Sklepi, ATVP_Smernice, BS_Regulacije)
 *   - provisions         — individual sklepi, smernice, and regulacije
 *   - enforcement_actions — ATVP and BS ukrepi and sankcije
 *
