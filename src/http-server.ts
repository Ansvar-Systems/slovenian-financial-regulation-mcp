...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in Slovenian" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., ATVP_SKLEPI, BS_REGULACIJE). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific Slovenian financial regulation provision by sourcebook and reference.",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., ATVP_SKLEPI, BS_REGULACIJE)" },
        reference: { type: "string", description: "Provision reference (e.g., 'ATVP_SKLEPI 2019/1 clen.5')" },
      },
  ...
  },
  {
    ...
    description: "List all Slovenian financial regulation sourcebooks with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "si_fin_search_enforcement",
    description:
      "Search ATVP and BS enforcement actions — ukrepi, sankcije, and prepovedi.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Check whether a specific Slovenian financial regulation provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
      ...
      switch (name) {
        ...
        case "si_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Slovenian Financial Regulation MCP server. Provides access to ATVP sklepi on capital markets and BS regulacije on banking supervision.",
            data_sources: [
